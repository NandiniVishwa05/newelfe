...
export default function AddEditPage() {
  ...
  // let enableUpdate = useSelector((state) => state.uid.enableUpdate);
  // const viewmode = useSelector((state) => state.uid.viewMode);
            ...
            <div className="nv-grid userforminputitem">
              ...
              <div className="nv-grid-column inputfield">
                <div className="checkboxwrapper">
                  <input type="checkbox" value={"1"} /> Reading
                </div>
                <div className="checkboxwrapper">
                  <input type="checkbox" value={"2"} /> Swimming
                </div>
                <div className="checkboxwrapper">
                  <input type="checkbox" value={"3"} /> Playing
                </div>
                <div className="checkboxwrapper">
                  <input type="checkbox" value={"4"} /> Singing
                </div>
              </div>
            </div>
          </div>
